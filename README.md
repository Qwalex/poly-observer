...
| Команда | Описание |
|---------|----------|
| `/start` | Подписка и справка |
| `/positions`, `/deals`, `/сделки` | Список открытых сделок с PnL |
| `/status` | WS, синхронизация, порог |
| `/refresh` | Принудительно обновить с Polymarket API |
